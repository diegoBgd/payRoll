	...
	private void searchSaisiePlan()
	{
		...
		if(selection!=null)
		{
			...
			else
			{
				...
				{
					disableSave=true;
					 HelperC.afficherAttention("ATTENTION", "Il faut param�trer la dur�e pour ce type de cong�");
					 return;
				}
				else
	...
	private void checkDays()
	{
		...
		if(getDateDebut()!=null && getDateFin()!=null)
		{
			...
			if(prmDure!=null)
			{
				...
				{
					disableSave=true;
					 HelperC.afficherAttention("ATTENTION", "Vous ne puvez pas d�passer la dur�e pour ce type de cong� !");
					 return;
				}
			}
		}
