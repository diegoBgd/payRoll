   ...
   public void enregistrer() {
     if (getId() == 0 && !this.droit.isCreer()) {
       HelperC.afficherAttention("ATTENTION", 
           "Vous n'avez pas le droit de cr�er");
       ...
       if (getId() == 0) {
         hist.setOperation("Cr�ation du parametrage des cong�s du personnel" + 
             getPersonnel().getDesignation());
       } else {
         hist.setOperation("du parametrage des cong�s du personnel" + 
             getPersonnel().getDesignation());
